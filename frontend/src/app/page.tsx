    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden pt-16">
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-1/4 top-32 h-96 w-96 rounded-full bg-blue-500/10 blur-3xl" />
          <div className="absolute right-1/4 top-64 h-96 w-96 rounded-full bg-emerald-500/10 blur-3xl" />
        </div>

        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm text-blue-700 dark:border-blue-800 dark:bg-blue-900/30 dark:text-blue-400">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/dashboard"
                className="flex items-center gap-2 rounded-xl bg-blue-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 hover:bg-blue-700"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 rounded-xl border border-gray-300 px-8 py-3.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
              >
          ...
          {/* Stats bar */}
          <div className="mx-auto mt-20 grid max-w-4xl grid-cols-2 gap-8 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-900 md:grid-cols-4">
            {[
              { label: "Smart Contracts", value: "5" },
              { label: "Chainlink Integrations", value: "6" },
              { label: "Cross-Chain Ready", value: "Yes" },
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-8 space-y-4">
                {[
                  ...
                  { icon: Shield, text: "OpenZeppelin battle-tested contract patterns with ReentrancyGuard" },
            ...
            <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-blue-50 to-emerald-50 p-8 dark:border-gray-700 dark:from-blue-900/20 dark:to-emerald-900/20">
              <div className="space-y-4 font-mono text-sm">
                <div className="text-gray-500 dark:text-gray-400">{"// Patient grants provider access"}</div>
                <div className="text-blue-600 dark:text-blue-400">{"function grantAccess("}</div>
                <div className="pl-4 text-gray-700 dark:text-gray-300">{"address provider"}</div>
                <div className="text-blue-600 dark:text-blue-400">{") external {"}</div>
      ...
      <section id="about" className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-gradient-to-r from-blue-600 to-emerald-500 px-8 py-16 text-center shadow-xl sm:px-16">
            ...
            <div className="mt-8 flex justify-center">
              <Link
                href="/dashboard"
                className="rounded-xl bg-white px-8 py-3.5 text-sm font-semibold text-blue-600 shadow-lg hover:bg-gray-100"
              >
                Enter Dashboard
              </Link>
            </div>
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">
                &copy; {new Date().getFullYear()} mediCaRE DAO
              </span>
            </div>
